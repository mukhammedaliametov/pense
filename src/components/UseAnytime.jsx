...
import UseAnytimeImg from "../assets/useanytime_img.png";
import { FaArrowRight } from "react-icons/fa6";

const UseAnytime = () => {
  return (
    <div className="max-w-[1220px] mx-auto px-[16px] py-[40px] lg:px-0 flex flex-col-reverse md:flex-row gap-[20px] items-top justify-between">
      ...
      <div>
        <img src={UseAnytimeImg} alt="real-time-img" />
      </div>
    </div>
  );
};
